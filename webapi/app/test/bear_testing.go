...
// GetBearBadRequest runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetBearBadRequest(t testing.TB, ctx context.Context, service *goa.Service, ctrl app.BearController, id string) http.ResponseWriter {
	t.Helper()
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "BearTest"), rw, req, prms)
	getCtx, err := app.NewGetBearContext(goaCtx, req, service)
	if err != nil {
		e, ok := err.(goa.ServiceError)
		if !ok {
...
// GetBearInternalServerError runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetBearInternalServerError(t testing.TB, ctx context.Context, service *goa.Service, ctrl app.BearController, id string) http.ResponseWriter {
	t.Helper()
...
// GetBearNotFound runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetBearNotFound(t testing.TB, ctx context.Context, service *goa.Service, ctrl app.BearController, id string) http.ResponseWriter {
	t.Helper()
...
// GetBearOK runs the method Get of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GetBearOK(t testing.TB, ctx context.Context, service *goa.Service, ctrl app.BearController, id string) (http.ResponseWriter, *app.Sighting) {
	t.Helper()
